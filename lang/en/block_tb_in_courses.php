...
/**
 * Lang strings for tb_in_courses block
 *
...
$string['tb_in_courses:addinstance'] = 'Add a new Leeloo LXP In Progress Courses block';
$string['tb_in_courses:myaddinstance'] = 'Add a new Leeloo LXP In Progress Courses block to Dashboard';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on Leeloo LXP In Progress Courses block, 0 will show all courses';
...
$string['pluginname'] = 'Leeloo LXP In Progress Courses';
$string['displayname'] = 'Leeloo LXP In Progress Courses';
...
$string['tb_in_courses_bgimage'] = "Embed images into background";
$string['tb_in_courses_bgimage_desc'] = "This will embed images into background as a CSS property";
...
$string['privacy:metadata'] = 'The Leeloo LXP In Progress Courses (tb_in_courses) block only shows information about courses and does not store data itself.';

$string['blocktitle'] = 'Leeloo LXP In Progress Courses';
